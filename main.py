...
avatar = Image.open('files\\austinavy.jpg')
...
bubbleCanvas = createBubble(avatar, 'because u have to spin it sideways to make it look like a tornado')
canvas.paste(bubbleCanvas, (0, titlebar.size[1]))

canvas.save('output\\output.png')